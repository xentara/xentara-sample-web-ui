...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('xentara-client.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('xentara-client.wasm', import.meta.url).href;
}
...
var __ZN7xentara10httpServer9websocket19AttributeIdentifier21kAttributeIdentifiersE = Module['__ZN7xentara10httpServer9websocket19AttributeIdentifier21kAttributeIdentifiersE'] = 179664;
...
Module.Error = class extends Error {
    constructor(message, wasClean) {
        // call the parent constructor
        super(message)
        // attach wasClean to the error
        this.wasClean = wasClean
    }
}

Module.ValueChangeEvent = class extends Event {
    constructor(value, options = {}) {
        super("valuechange", options);
...
Module.ErrorEvent = class extends Event {
    constructor(type, reason, wasClean, options = {}) {
        super(type, options);
        ...
        Object.defineProperty(this, 'wasClean', {
            value: wasClean,
            writable: false
        })
    }
...
Module._internalScheduleFlushHelper = function (connection) {
    // enqueue the flush microtask
    queueMicrotask(() => connection.flush())
}

Module._internalWritePromiseHelper = function (connection, attribute, value) {
    return new Promise((resolve, reject) => {
        let observer = new Module._InternalCommandObserver()
        ...
        connection._internalWrite(attribute, value, observer)
    })
}

Module._internalConnectPromiseHelper = function (connection, url) {
    return new Promise((resolve, reject) => {
        let observer = new Module._InternalCommandObserver()
        ...
        connection._internalConnect(url, observer)
    })
}

Module._internalSubscribePromiseHelper = function (connection, subscription) {
    return new Promise((resolve, reject) => {
        let observer = new Module._InternalCommandObserver()
        ...
        connection._internalSubscribe(subscription, observer)
    })
}

Module._internalUnsubscribePromiseHelper = function (connection, subscription) {
    return new Promise((resolve, reject) => {
        let observer = new Module._InternalCommandObserver()
        ...
        connection._internalUnsubscribe(subscription, observer)
    })
}

Module._internalLookupElementPromiseHelper = function (connection, primaryKey) {
    return new Promise((resolve, reject) => {
        let observer = new Module._InternalCommandObserver()
        ...
        connection._internalLookupElement(primaryKey, observer)
    })
}

Module._internalBrowsePromiseHelper = function (connection, element, parameters) {
    return new Promise((resolve, reject) => {
        let observer = new Module._InternalCommandObserver()

        observer.onsuccess = (elementEntries) => {
            resolve(elementEntries)
        }
        ...
        connection._internalBrowse(element, parameters, observer)
    })
}

Module._internalMetadataPromiseHelper = function (connection, element, identifiers) {
    return new Promise((resolve, reject) => {
        let observer = new Module._InternalCommandObserver()

        observer.onsuccess = (elementMetadata) => {
            resolve(elementMetadata)
        }
        ...
        connection._internalMetadata(element, identifiers, observer)
    })
}
...
export default createXentaraModule;
